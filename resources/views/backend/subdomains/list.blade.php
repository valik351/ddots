    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-2 col-xs-2">
                <a class="btn btn-primary" href="{{ route('backend::subdomains::add') }}" role="button">Add Subdomain</a>
            </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($subdomains as $subdomain)
                                <tr>
                                    ...
                                    <td>
                                        <a title="Edit"
                                           href="{{ action('Backend\SubdomainController@edit',['id'=> $subdomain->id]) }}"><span

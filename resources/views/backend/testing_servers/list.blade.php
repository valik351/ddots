    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-2 col-xs-2">
                <a class="btn btn-primary" href="{{ route('backend::testing_servers::add') }}" role="button">Add
                    Server</a>
            </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($servers as $server)
                                <tr>
                                    ...
                                    <td>
                                        <a title="Edit"
                                           href="{{ action('Backend\TestingServersController@edit',['id'=> $server->id]) }}">
                                        ...
                                        @if (!$server->deleted_at)
                                            <a title="Delete" href="" data-toggle="confirmation"
                                               ...
                                               data-btn-ok-href="{{ action('Backend\TestingServersController@delete', ['id'=> $server->id]) }}"
                                        ...
                                        @else
                                            <a title="Restore" href="" data-toggle="confirmation"
                                               ...
                                               data-btn-ok-href="{{ action('Backend\TestingServersController@restore', ['id'=> $server->id]) }}"
